...
@else
<salary usersdata='{!! json_encode($service->getUserOptions()) !!}'
    daysdata='{!! cal_days_in_month(CAL_GREGORIAN, $service->getMonth(),$service->getYear()) !!}'
    monthdata="{!! $service->getMonth() !!}" yeardata="{!! $service->getYear() !!}"
    salariesdata='{!! json_encode($service->getAll()) !!}' routersalary={!!route('salary.store')!!}
