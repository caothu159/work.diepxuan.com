    ...
    <div class="col-12">
        <div class="row" :key="componentKey">
            <template v-for="nv in nhanvien">
                    ...
                    <div class="card text-decoration-none collapsed h-100" :id="'heading' + nv.index">
                        ...
                        <div class="card-body p-2">
                            <div class="card-text font-weight-light text-info">
                                ...
                                <div class="d-flex justify-content-between">
                                    Công:
                                    <a class="font-weight-normal font-weight-bold" data-toggle="collapse"
                                       aria-expanded="false" :href="'#collapse' + nv.index"
                ...
                <div class="col-sm-12 collapse" :id="'collapse' + nv.index" :aria-labelledby="'heading' + nv.index"
